 ...
 *  - ErrorMessages: Provides formatted error message templates for file I/O issues, unknown opcodes,
 *    and memory/stack access violations.
 *  - HardcodedValues: Defines various configuration constants including command-line argument indices,
 *    register values, memory size, stack size, and other limits essential for the simulation.
 *
 * These definitions help ensure consistency in error handling and configuration across the entire codebase.
 *
 * @author: Dmytro Lunhu
 * @ate: April 21, 2025
 */
...
class ErrorMessages {
 ...
 private:
  static constexpr string_view FILE_NOT_PROVIDED_ERROR =
      "Program file path was not provided.";
  static constexpr string_view UNABLE_TO_OPEN_FILE_ERROR =
      "Unable to open file: ";
  static constexpr string_view UNKNOWN_OPCODE_ERROR = "Unknown opcode: ";
  static constexpr string_view WRITING_TO_STACK_REGION_ERROR =
      "Error: writing to stack region ";
